        ...
        <div class="tabbable tabs-left tabsmargin">
            <ul id="tabs" class="nav nav-tabs">
                <li class="active"><a href="#Druid" data-toggle="tab">
                    <img alt="Druid" src="../Images/Hearthstone/Icons/DruidIcon.png" />
                    Druid</a></li>
                <li><a href="#Hunter" data-toggle="tab">
                    <img alt="Hunter" src="../Images/Hearthstone/Icons/HunterIcon.png" />
                    Hunter</a></li>
                <li><a href="#Mage" data-toggle="tab">
                    <img alt="Mage" src="../Images/Hearthstone/Icons/MageIcon.png" />
                    Mage</a></li>
                <li><a href="#Paladin" data-toggle="tab">
                    <img alt="Paladin" src="../Images/Hearthstone/Icons/PaladinIcon.png" />
                    Paladin</a></li>
                <li><a href="#Priest" data-toggle="tab">
                    <img alt="Priest" src="../Images/Hearthstone/Icons/PriestIcon.png" />
                    Priest</a></li>
                <li><a href="#Rogue" data-toggle="tab">
                    <img alt="Rogue" src="../Images/Hearthstone/Icons/RogueIcon.png" />
                    Rogue</a></li>
                <li><a href="#Shaman" data-toggle="tab">
                    <img alt="Shaman" src="../Images/Hearthstone/Icons/ShamanIcon.png" />
                    Shaman</a></li>
                <li><a href="#Warlock" data-toggle="tab">
                    <img alt="Warlock" src="../Images/Hearthstone/Icons/WarlockIcon.png" />
                    Warlock</a></li>
                <li><a href="#Warrior" data-toggle="tab">
                    <img alt="Warrior" src="../Images/Hearthstone/Icons/WarriorIcon.png" />
                    Warrior</a></li>
            </ul>
            <div id="mytabs" class="tab-content">
                <div class="tab-pane active tabpadding" id="Druid">
                    <img class="HeroPic" alt="Malfurion" title="Malfurion" src="../Images/Hearthstone/HeroesPics/Malfurion.png" />
                    ...
                    <img class="AbilityIcon" alt="Druid" title="Druid" src="../Images/Hearthstone/AbilityIcon/Druid.png" />
                    <br />
                    ...
                    <img class="Card" alt="Cenarious" src="../Images/Hearthstone/Cards/Cenarius.png" />
                    <p><span class="bigword">CENARIOUS:</span> is the ultimate card needed for any Druid deck who wants to take a heavy board presence going into late game! For 8 cost Cenarius is a 5 attack 8 health minion who gives the user one of two choices.</p>
                    <ol id="CeneriusChoices">
                ...
                <div class="tab-pane tabpadding" id="Hunter">
                    <img class="HeroPic" alt="Rexxar" src="../Images/Hearthstone/HeroesPics/Rexxar.jpg" />
                    ...
                    <img class="AbilityIcon" alt="Hunter" title="Hunter" src="../Images/Hearthstone/AbilityIcon/Hunter.png" />
                    <br />
                    <h3 style="color: #FFF">Hero Power:</h3>
                    <p><span class="bigword">Steady Shot:</span> Deal 2 damage to the enemy hero</p>
                    <br />
                    <h3 class="HearthHeaders">Legendary Card:</h3>
                    <img class="Card" alt="Cenarious" src="../Images/Hearthstone/Cards/King.png" />
                ...
                <div class="tab-pane tabpadding" id="Mage">
                    <img class="HeroPic" alt="Jaina" src="../Images/Hearthstone/HeroesPics/Jaina.jpg" />
                    ...
                    <img class="AbilityIcon" alt="Mage" title="Mage" src="../Images/Hearthstone/AbilityIcon/Mage.png" />
                    <br />
                    <h3 style="color: #FFF">Hero Power:</h3>
                    <p><span class="bigword">Fireblast:</span> Deal 1 damage(this can hit any character, of your choice, on the board)</p>
                    <br />
                    <h3 class="HearthHeaders">Legendary Card:</h3>
                    <img class="Card" alt="Archmage" src="../Images/Hearthstone/Cards/Archmage.png" />
                ...
                <div class="tab-pane tabpadding" id="Paladin">
                    <img class="HeroPic" alt="Uther" src="../Images/Hearthstone/HeroesPics/Uther.jpg" />
                    ...
                    <img class="AbilityIcon" alt="Paladin" title="Paladin" src="../Images/Hearthstone/AbilityIcon/paladin.png" />
                    ...
                    <br />
                    <h3 class="HearthHeaders">Legendary Card:</h3>
                    <img class="Card" alt="Tirion" src="../Images/Hearthstone/Cards/Tirion.png" />
                ...
                <div class="tab-pane tabpadding" id="Priest">
                    <img class="HeroPic" alt="Anduin" src="../Images/Hearthstone/HeroesPics/Anduin.png" />
                    ...
                    <img class="AbilityIcon" alt="Priest" title="Priest" src="../Images/Hearthstone/AbilityIcon/priest.png" />
                    <br />
                    <h3 style="color: #FFF">Hero Power:</h3>
                    ...
                    <br />
                    <h3 class="HearthHeaders">Legendary Card:</h3>
                    <img class="Card" alt="Prophet Velen" src="../Images/Hearthstone/Cards/Velen.png" />
                ...
                <div class="tab-pane tabpadding" id="Rogue">
                    <img class="HeroPic" alt="Valeera" src="../Images/Hearthstone/HeroesPics/Valeera.jpg" />
                    ...
                    <img class="AbilityIcon" alt="Priest" title="Priest" src="../Images/Hearthstone/AbilityIcon/rogue.png" />
                    <br />
                    <h3 style="color: #FFF">Hero Power:</h3>
                    <p><span class="bigword">Dagger Mastery:</span> Equip a 1/2 Dagger; or Give your weapon +1 Attack this turn.</p>
                    <br />
                    <h3 class="HearthHeaders">Legendary Card:</h3>
                    <img class="Card" alt="Edwin VanCleef" src="../Images/Hearthstone/Cards/VanCleef.png" />
                ...
                <div class="tab-pane tabpadding" id="Shaman">
                    <img class="HeroPic" alt="Thrall" src="../Images/Hearthstone/HeroesPics/Thrall.jpg" />
                    ...
                    <img class="AbilityIcon" alt="Shaman" title="Shaman" src="../Images/Hearthstone/AbilityIcon/shaman.png" />
                    <br />
                    <h3 style="color: #FFF">Hero Power:</h3>
                    <p>
                    ...
                    <br />
                    <h3 class="HearthHeaders">Legendary Card:</h3>
                    <img class="Card" alt="Al'Akir the Windlord" src="../Images/Hearthstone/Cards/Windlord.png" />
                ...
                <div class="tab-pane tabpadding" id="Warlock">
                    <img class="HeroPic" alt="Gul'dan" src="../Images/Hearthstone/HeroesPics/Gul'dan.jpg" />
                    ...
                    <img class="AbilityIcon" alt="Warlock" title="Warlock" src="../Images/Hearthstone/AbilityIcon/warlock.png" />
                    <br />
                    <h3 style="color: #FFF">Hero Power:</h3>
                    <p><span class="bigword">Life Tap:</span> Draw a card and take 2 damage to your hero.</p>
                    <br />
                    <h3 class="HearthHeaders">Legendary Card:</h3>
                    <img class="Card" alt="Lord Jaraxxus" src="../Images/Hearthstone/Cards/Jaraxxus.png" />
                ...
                <div class="tab-pane tabpadding" id="Warrior">
                    <img class="HeroPic" alt="Garrosh Hellscream" src="../Images/Hearthstone/HeroesPics/Garrosh.jpg" />
                    ...
                    <img class="AbilityIcon" alt="Warrior" title="Warrior" src="../Images/Hearthstone/AbilityIcon/warrior.png" />
                    <br />
                    <h3 style="color: #FFF">Hero Power:</h3>
                    <p><span class="bigword">Armor Up:</span> Gain 2 Armor. (This is stackable and lasts until used)</p>
                    <br />
                    <h3 class="HearthHeaders">Legendary Card:</h3>
                    <img class="Card" alt="Grom Hellscream" src="../Images/Hearthstone/Cards/Grom.png" />
