        ...
        <asp:Panel ID="pnlAddSection" runat="server" Visible="false">
            ...
            <div class="row-fluid">
                <div id="divHeroUsed" class="heroUsed span4">
                    ...
                    <br />
                    <asp:Image runat="server" id="imgSelectedHero" alt="Your Hero" class="statsHeroImg" ImageUrl="/Images/Hearthstone/HeroesPics/Malfurion.jpg" />
                </div>
                ...
                <div id="divHeroAgainst" class="heroAgainst span4">
                    ...
                    <br />
                    <asp:Image runat="server" id="imgOpponentHero" alt="Your Hero" class="statsHeroImg" ImageUrl="/Images/Hearthstone/HeroesPics/Malfurion.jpg" />
                </div>
            </div>
            <br />
